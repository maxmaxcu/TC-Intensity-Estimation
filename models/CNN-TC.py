...
import os
from tools import Dataset,loss_func_mse,test_epoch
...
class Net(nn.Module):
    def __init__(self,args):
        ...
        self.conv2d_0 = nn.Conv2d(2, 16, 4, stride=2,padding=1) # 64 in
        ...
        self.linear_0 = nn.Linear(4*4*128+args.extra_features, 256)
...
def train(args, model, optimizer, scheduler):
    ...
    for epoch in range(args.epochs+1):
        ...
        if epoch % args.log_interval == 0:
            logtxt.write(f'Train Epoch: {epoch}, duration: {round(time.time()-start_time)}'+'\n')
...
if __name__=="__main__":
    ...
    parser.add_argument("-Tx", "--trainset_xpath", default="", help="the trainning set x file path")
